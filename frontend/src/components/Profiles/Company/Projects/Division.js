...
import { Container, Col, Row, Card, Button, Form,Dropdown } from 'react-bootstrap';
import { Link } from "react-router-dom";
import {scrollTop} from '../../../Extra/LinkOnTop'
import { BsFillShiftFill } from "react-icons/bs";
import { uploadDivision, removeAssign} from './ProjectUtils';
            ...
            <Row>
                { division?.assign ? 
                    (
                            ...
                            <Col className="d-flex justify-content-end">
                                {admin_slug === user.slug && 
                                    <Dropdown show={assignOptsOpen} onToggle={toggleDropdown}>
                                        ...
                                        <Dropdown.Menu>
                                            <Button variant="danger" onClick={() => removeAssign(division.division, division.assign.participant_id,setDivisions)}>Remove</Button>
                                        </Dropdown.Menu>
                                    </Dropdown>
                                }
                            </Col>
                        ...
                        admin_slug === user.slug && <DivisionInvite division={division.division} company={company} admin_slug={admin_slug} user_slug={user.slug} setDivisions={setDivisions}/>
                    )
                }
            </Row>                   
            </Card.Header>
