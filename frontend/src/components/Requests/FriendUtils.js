...
export const replyRequest = async( sender, info, receiver, status, setRequests, addNotification, token) => {
...
export const replyRequestProfile = async( sender, receiver, status, setRequested, addNotification, token) => {
